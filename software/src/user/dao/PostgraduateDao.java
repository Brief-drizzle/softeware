...
public interface PostgraduateDao {
     ...
     * @return 对象列表
     */
    List<Postgraduate> queryAllByLimit(@Param("offset") int offset, @Param("limit") int limit, @Param("teacherId") String teacherId);
    ...
    Integer queryNumber(@Param("teacherId") String teacherId);

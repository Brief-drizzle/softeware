...
public class AcademicExchange implements Serializable {
    ...
    private String tutorAuditTimeStr;

    private Date directorAuditTime;

    private String directorAuditTimeStr;

    public String getTutorAuditTimeStr() {
        return tutorAuditTimeStr;
    }

    public void setTutorAuditTimeStr(String tutorAuditTimeStr) {
        this.tutorAuditTimeStr = tutorAuditTimeStr;
    }

    public String getDirectorAuditTimeStr() {
        return directorAuditTimeStr;
    }

    public void setDirectorAuditTimeStr(String directorAuditTimeStr) {
        this.directorAuditTimeStr = directorAuditTimeStr;
    }

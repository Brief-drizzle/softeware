//@sourceURL=/js/academicExchangeStudent.js
$(function() {

    var table = layui.table;

    table.render({
        elem: '#academicExchangeStudent-list',
        url: getBasePath() + '/academicExchange/getByPage.do?self=' + getId(),
        id: 'academicExchangeStudentReload',
        even: true,
        cols: [[

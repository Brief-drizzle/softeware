...
<%
    ...
    String postgraduateId = (String) request.getAttribute("postgraduateId");
%>
        ...
        <div class="layui-form-item" style="margin: 20px;">
            ...
            <div class="layui-card">
                ...
                <div class="layui-card-body">
                    <table class="layui-hide" id="academicExchangeStudent-list" lay-filter="academicExchangeStudent-list" style="margin: 10px;"></table>
                </div>
            </div>
        </div>
    </div>
...
<script type="text/javascript" src="<%=basePath%>/js/academicExchangeStudent.js"></script>
</body>
</html>

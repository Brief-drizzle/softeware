//@sourceURL=/js/participateProject.js
$(function() {
        ...
        cols: [[
            {field: 'participateProjectId', title: '档案id'},
            {
                field: 'projectName', title: '项目名称', templet: function(d) {
                    return '<a href="' + getBasePath() + '/participateProject/detail.do?id=' + d.participateProjectId + '">' + d.projectName + '</a>';
                }
            },
            {
    ...
    // 头工具栏事件
    table.on('toolbar(participateProject-list)', function(obj) {
        if (obj.event == 'participateProject-add-btn') {
            window.location.href = getBasePath() + "/jsp/AddParticipateProject.jsp";
        }
    });

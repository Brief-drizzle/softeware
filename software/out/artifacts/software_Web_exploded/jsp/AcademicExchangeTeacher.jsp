        ...
        <div class="layui-form-item" style="margin: 20px;">
            ...
            <div class="layui-card">
                ...
                <div class="layui-card-body">
                    <table class="layui-hide" id="academicExchangeTeacher-list" lay-filter="academicExchangeTeacher-list" style="margin: 10px;"></table>
                </div>
            </div>
        </div>
    </div>
</div>
<script type="text/html" id="academicExchangeTeacherListBar">
...
<script type="text/javascript" src="<%=basePath%>/js/academicExchangeTeacher.js"></script>
</body>
</html>

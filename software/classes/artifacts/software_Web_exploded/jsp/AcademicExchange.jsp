    ...
    <div class="layui-body">
        <div class="layui-form-item" style="margin: 20px;">
            ...
            <div class="layui-card">
                <div class="layui-card-header" id="title">学术交流活动建档管理</div>
                <div class="layui-card-body">
                    <table class="layui-hide" id="academicExchange-list" lay-filter="academicExchange-list" style="margin: 10px;"></table>
                </div>
            </div>
        </div>
    </div>
...
<script type="text/javascript" src="<%=basePath%>/js/academicExchange.js"></script>
</body>
</html>
